        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventQrCode = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SlotType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Venues_Properties_PropertyId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EventId = table.Column<int>(type: "int", nullable: false),
                    ParkingAreaId = table.Column<int>(type: "int", nullable: false),
                    AllocatedSlotCount = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EventParkingAllocations", x => x.Id);
                    table.ForeignKey(
                        name: "FK_EventParkingAllocations_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EventParkingAllocations_ParkingAreas_ParkingAreaId",
                        column: x => x.ParkingAreaId,
                        principalTable: "ParkingAreas",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SetupStatus = table.Column<string>(type: "nvarchar(30)", maxLength: 30, nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingParkings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookingParkings_Bookings_BookingId",
                        column: x => x.BookingId,
                        principalTable: "Bookings",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookingParkings_ParkingSlots_ParkingSlotId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OtpVerifications_Payments_PaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingParkings_BookingId",
                table: "BookingParkings",
                column: "BookingId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_BookingParkings_ParkingSlotId",
                table: "BookingParkings",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventApprovals_EventId_Status",
                table: "EventApprovals",
                columns: new[] { "EventId", "Status" });

            migrationBuilder.CreateIndex(
                name: "IX_EventApprovals_RequestedByUserId",
                table: "EventApprovals",
                column: "RequestedByUserId");

            migrationBuilder.CreateIndex(
                name: "IX_EventApprovals_ReviewedByUserId",
                table: "EventApprovals",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EventParkingAllocations_EventId",
                table: "EventParkingAllocations",
                column: "EventId");

            migrationBuilder.CreateIndex(
                name: "IX_EventParkingAllocations_EventId_ParkingAreaId",
                table: "EventParkingAllocations",
                columns: new[] { "EventId", "ParkingAreaId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_EventParkingAllocations_ParkingAreaId",
                table: "EventParkingAllocations",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Events_EventQrCode",
                table: "Events",
                column: "EventQrCode",
                unique: true,
                filter: "[EventQrCode] IS NOT NULL");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OtpVerifications_PaymentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ParkingAreas_VenueId_Name",
                table: "ParkingAreas",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Venues_PropertyId_Name",
                table: "Venues",
